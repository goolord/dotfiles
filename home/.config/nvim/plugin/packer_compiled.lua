...
_G.packer_plugins = {
  ...
  ferret = {
    commands = { "Ack", "Ack!", "Acks", "Back", "Back!", "Black", "Black!", "Quack", "Quack!", "Lack", "Lack!", "Lacks", "FerretCancelAsync", "FerretPullAsync", "Qargs", "Largs" },
    loaded = false,
    needs_bufread = true,
    path = "/home/zach/.local/share/nvim/site/pack/packer/opt/ferret"
  },
  ghcid = {
  ...
  ["vim-clap"] = {
    config = { "\27LJ\1\2â\4\0\0\2\0\16\0%4\0\0\0007\0\1\0%\1\3\0:\1\2\0004\0\0\0007\0\1\0%\1\5\0:\1\4\0004\0\0\0007\0\1\0003\1\a\0:\1\6\0004\0\0\0007\0\1\0)\1\2\0:\1\b\0004\0\0\0007\0\1\0'\1\1\0:\1\t\0004\0\0\0007\0\1\0'\1\1\0:\1\n\0004\0\0\0007\0\1\0003\1\f\0:\1\v\0004\0\0\0007\0\1\0003\1\14\0:\1\r\0004\0\0\0007\0\1\0'\1d\0:\1\15\0G\0\1\0\29clap_provider_grep_delay\1\t\0\0\tüåë\tüåí\tüåì\tüåî\tüåï\tüåñ\tüåó\tüåò\24clap_spinner_frames\1\0\3\vtexthl\29ClapCurrentSelectionSign\ttext\vÔÅîÔÅî\vlinehl\25ClapCurrentSelection clap_current_selection_sign#clap_provider_grep_enable_icon\21clap_enable_icon\28clap_disable_run_rooter\1\0\3\brow\b11%\rrelative\veditor\vheight\b80%\16clap_layout\17gruvbox_dark\15clap_theme\bnil\22clap_popup_border\6g\bvim\0" },
    loaded = true,
...
try_loadstring("\27LJ\1\2â\4\0\0\2\0\16\0%4\0\0\0007\0\1\0%\1\3\0:\1\2\0004\0\0\0007\0\1\0%\1\5\0:\1\4\0004\0\0\0007\0\1\0003\1\a\0:\1\6\0004\0\0\0007\0\1\0)\1\2\0:\1\b\0004\0\0\0007\0\1\0'\1\1\0:\1\t\0004\0\0\0007\0\1\0'\1\1\0:\1\n\0004\0\0\0007\0\1\0003\1\f\0:\1\v\0004\0\0\0007\0\1\0003\1\14\0:\1\r\0004\0\0\0007\0\1\0'\1d\0:\1\15\0G\0\1\0\29clap_provider_grep_delay\1\t\0\0\tüåë\tüåí\tüåì\tüåî\tüåï\tüåñ\tüåó\tüåò\24clap_spinner_frames\1\0\3\vtexthl\29ClapCurrentSelectionSign\ttext\vÔÅîÔÅî\vlinehl\25ClapCurrentSelection clap_current_selection_sign#clap_provider_grep_enable_icon\21clap_enable_icon\28clap_disable_run_rooter\1\0\3\brow\b11%\rrelative\veditor\vheight\b80%\16clap_layout\17gruvbox_dark\15clap_theme\bnil\22clap_popup_border\6g\bvim\0", "config", "vim-clap")
...
try_loadstring("\27LJ\1\2_\0\2\a\0\5\0\t4\2\0\0007\2\1\0027\2\2\2%\3\3\0\16\4\0\0\16\5\1\0003\6\4\0>\2\5\1G\0\1\0\1\0\3\texpr\2\vsilent\2\fnoremap\2\6i\20nvim_set_keymap\bapi\bvim°\1\1\0\6\0\b\0\n1\0\0\0004\1\1\0007\1\2\0017\1\3\1%\2\4\0%\3\5\0%\4\6\0003\5\a\0>\1\5\1G\0\1\0\1\0\2\texpr\2\fnoremap\1Cvsnip#available(1)  ? '<Plug>(vsnip-expand-or-jump)' : '<C-l>'\n<C-l>\6i\20nvim_set_keymap\bapi\bvim\0\0", "config", "vim-vsnip")
time([[Config for vim-vsnip]], false)

-- Command lazy-loads
time([[Defining lazy-load commands]], true)
pcall(vim.cmd, [[command! -nargs=* -range -bang -complete=file Back lua require("packer.load")({'ferret'}, { cmd = "Back", l1 = <line1>, l2 = <line2>, bang = <q-bang>, args = <q-args> }, _G.packer_plugins)]])
pcall(vim.cmd, [[au CmdUndefined Ack! ++once lua require"packer.load"({'ferret'}, {}, _G.packer_plugins)]])
pcall(vim.cmd, [[command! -nargs=* -range -bang -complete=file Lack lua require("packer.load")({'ferret'}, { cmd = "Lack", l1 = <line1>, l2 = <line2>, bang = <q-bang>, args = <q-args> }, _G.packer_plugins)]])
pcall(vim.cmd, [[command! -nargs=* -range -bang -complete=file FerretCancelAsync lua require("packer.load")({'ferret'}, { cmd = "FerretCancelAsync", l1 = <line1>, l2 = <line2>, bang = <q-bang>, args = <q-args> }, _G.packer_plugins)]])
pcall(vim.cmd, [[au CmdUndefined Quack! ++once lua require"packer.load"({'ferret'}, {}, _G.packer_plugins)]])
pcall(vim.cmd, [[command! -nargs=* -range -bang -complete=file Ack lua require("packer.load")({'ferret'}, { cmd = "Ack", l1 = <line1>, l2 = <line2>, bang = <q-bang>, args = <q-args> }, _G.packer_plugins)]])
pcall(vim.cmd, [[command! -nargs=* -range -bang -complete=file Acks lua require("packer.load")({'ferret'}, { cmd = "Acks", l1 = <line1>, l2 = <line2>, bang = <q-bang>, args = <q-args> }, _G.packer_plugins)]])
pcall(vim.cmd, [[command! -nargs=* -range -bang -complete=file Largs lua require("packer.load")({'ferret'}, { cmd = "Largs", l1 = <line1>, l2 = <line2>, bang = <q-bang>, args = <q-args> }, _G.packer_plugins)]])
pcall(vim.cmd, [[command! -nargs=* -range -bang -complete=file Qargs lua require("packer.load")({'ferret'}, { cmd = "Qargs", l1 = <line1>, l2 = <line2>, bang = <q-bang>, args = <q-args> }, _G.packer_plugins)]])
pcall(vim.cmd, [[au CmdUndefined Lack! ++once lua require"packer.load"({'ferret'}, {}, _G.packer_plugins)]])
pcall(vim.cmd, [[command! -nargs=* -range -bang -complete=file Lacks lua require("packer.load")({'ferret'}, { cmd = "Lacks", l1 = <line1>, l2 = <line2>, bang = <q-bang>, args = <q-args> }, _G.packer_plugins)]])
pcall(vim.cmd, [[command! -nargs=* -range -bang -complete=file Quack lua require("packer.load")({'ferret'}, { cmd = "Quack", l1 = <line1>, l2 = <line2>, bang = <q-bang>, args = <q-args> }, _G.packer_plugins)]])
...
pcall(vim.cmd, [[command! -nargs=* -range -bang -complete=file FerretPullAsync lua require("packer.load")({'ferret'}, { cmd = "FerretPullAsync", l1 = <line1>, l2 = <line2>, bang = <q-bang>, args = <q-args> }, _G.packer_plugins)]])
...
pcall(vim.cmd, [[au CmdUndefined Back! ++once lua require"packer.load"({'ferret'}, {}, _G.packer_plugins)]])
pcall(vim.cmd, [[command! -nargs=* -range -bang -complete=file Black lua require("packer.load")({'ferret'}, { cmd = "Black", l1 = <line1>, l2 = <line2>, bang = <q-bang>, args = <q-args> }, _G.packer_plugins)]])
pcall(vim.cmd, [[au CmdUndefined Black! ++once lua require"packer.load"({'ferret'}, {}, _G.packer_plugins)]])
